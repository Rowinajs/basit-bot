...
if(!args[0]) return message.channel.send('> Bir link ve ad yazmalısın. `.emoji-ekle https://cdn.discordapp.com/emojis/xx.png İnfinity`');
if(!args[0].endsWith('.png')) return message.channel.send('Doğru bir link yazmalısın.');
if(!args[1]) return message.channel.send('> Bir emoji adı yazmalısın. `.emoji-ekle https://cdn.discordapp.com/attachments/xx/ico.png İnfinity`');
